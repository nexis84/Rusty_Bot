...
(function () {
  ...
  const SCOPES = ['esi-characters.read_blueprints.v1', 'esi-corporations.read_blueprints.v1', 'esi-assets.read_assets.v1', 'esi-assets.read_corporation_assets.v1', 'esi-skills.read_skills.v1', 'esi-universe.read_structures.v1'];
