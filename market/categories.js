...
const SubCategories = {
    ...
    // Blueprints subcategories
    blueprints: {
        groups: [
            { id: "ship_blueprints", name: "Ship Blueprints", filter: (item) => ['Rifter', 'Condor', 'Executioner', 'Atron', 'Bantam', 'Navitas', 'Burst', 'Slasher', 'Vigil', 'Merlin', 'Incursus', 'Imicus', 'Heron', 'Kestrel', 'Probe', 'Crucifier', 'Tristan', 'Breacher', 'Inquisitor', 'Tormentor', 'Punisher', 'Griffin', 'Osprey', 'Augoror', 'Vexor', 'Thorax', 'Moa', 'Caracal', 'Blackbird', 'Bellicose', 'Celestis', 'Arbitrator', 'Rupture', 'Stabber', 'Maller', 'Moa', 'Ferox', 'Brutix', 'Cyclone', 'Prophecy', 'Harbinger', 'Drake', 'Myrmidon', 'Hurricane', 'Hurricane Fleet', 'Abaddon', 'Apocalypse', 'Rokh', 'Raven', 'Megathron', 'Hyperion', 'Tempest', 'Typhoon', 'Maelstrom', 'Dominix', 'Scorpion', 'Armageddon', 'Apocalypse', 'Naga', 'Oracle', 'Talos', 'Tornado', 'Naga', 'Phantasm', 'Succubus', 'Gila', 'Cynabal', 'Vigilant', 'Ashimmu', 'Bhaalgorn', 'Stratios', 'Orthrus', 'Barghest', 'Machariel', 'Nightmare', 'Vindicator', 'Rattlesnake', 'Dramiel', 'Worm', 'Daredevil', 'Cruor', 'Garmur', 'Venture', 'Prospect', 'Endurance', 'Primae', 'Noctis', 'Porpoise', 'Orca', 'Rorqual', 'Bowhead', 'Charon', 'Fenrir', 'Obelisk', 'Ark', 'Providence', 'Thanatos', 'Chimera', 'Nidhoggur', 'Archon', 'Moros', 'Naglfar', 'Phoenix', 'Revelation', 'Avatar', 'Erebus', 'Ragnarok', 'Leviathan', 'Hel', 'Nyx', 'Aeon', 'Wyvern', 'Vulture', 'Basilisk', 'Cerberus', 'Drake Navy', 'Ferox Navy', 'Brutix Navy', 'Harbinger Navy', 'Caracal Navy', 'Vexor Navy', 'Osprey Navy', 'Scythe Fleet', 'Thorax Navy', 'Exequror Navy', 'Bellicose Fleet', 'Augoror Navy', 'Rupture Fleet', 'Maller', 'Blackbird', 'Celestis', 'Arbitrator', 'Wolf', 'Jaguar', 'Hawk', 'Harpy', 'Enyo', 'Ishkur', 'Retribution', 'Vengeance', 'Crusader', 'Malediction', 'Taranis', 'Claw', 'Raptor', 'Crow', 'Hookbill', 'Kestrel', 'Corax', 'Griffin Navy', 'Bantam', 'Merlin', 'Kirin', 'Bifrost', 'Pontifex', 'Scalpel', 'Dagger', 'Stiletto', 'Malediction', 'Ares', 'Anathema', 'Helios', 'Buzzard', 'Cheetah', 'Manticore', 'Nemesis', 'Hound', 'Purifier', 'Keres', 'Hyena', 'Sentinel', 'Kitsune', 'Vigil Fleet', 'Keres', 'Probe', 'Imicus', 'Heron', 'Magnate', 'Gnosis', 'Apotheosis', 'Echelon', 'Sunesis'].some(n => item.name.includes(n + ' Blueprint')) },
            { id: "module_blueprints", name: "Module Blueprints", filter: (item) => item.name.toLowerCase().includes('blueprint') && (item.name.toLowerCase().includes('laser') || item.name.toLowerCase().includes('blaster') || item.name.toLowerCase().includes('railgun') || item.name.toLowerCase().includes('cannon') || item.name.toLowerCase().includes('missile') || item.name.toLowerCase().includes('launcher') || item.name.toLowerCase().includes('turret') || item.name.toLowerCase().includes('afterburner') || item.name.toLowerCase().includes('microwarpdrive') || item.name.toLowerCase().includes('shield') || item.name.toLowerCase().includes('armor') || item.name.toLowerCase().includes('repairer') || item.name.toLowerCase().includes('harden') || item.name.toLowerCase().includes('plating') || item.name.toLowerCase().includes('sensor') || item.name.toLowerCase().includes(' ECM') || item.name.toLowerCase().includes('warp') || item.name.toLowerCase().includes('capacitor') || item.name.toLowerCase().includes('power') || item.name.toLowerCase().includes('reactor') || item.name.toLowerCase().includes('mining') || item.name.toLowerCase().includes('harvester') || item.name.toLowerCase().includes('strip miner') || item.name.toLowerCase().includes('drill') || item.name.toLowerCase().includes('tractor') || item.name.toLowerCase().includes('salvager') || item.name.toLowerCase().includes('codebreaker') || item.name.toLowerCase().includes('analyzer') || item.name.toLowerCase().includes('probe launcher') || item.name.toLowerCase().includes('scanner')) && !['Rifter', 'Condor', 'Executioner', 'Atron', 'Bantam', 'Navitas', 'Burst', 'Slasher', 'Vigil', 'Merlin', 'Incursus', 'Imicus', 'Heron', 'Kestrel', 'Probe', 'Crucifier', 'Tristan', 'Breacher', 'Inquisitor', 'Tormentor', 'Punisher', 'Griffin', 'Osprey', 'Augoror', 'Vexor', 'Thorax', 'Moa', 'Caracal', 'Blackbird', 'Bellicose', 'Celestis', 'Arbitrator', 'Rupture', 'Stabber', 'Maller', 'Ferox', 'Brutix', 'Cyclone', 'Prophecy', 'Harbinger', 'Drake', 'Myrmidon', 'Hurricane', 'Abaddon', 'Apocalypse', 'Rokh', 'Raven', 'Megathron', 'Hyperion', 'Tempest', 'Typhoon', 'Maelstrom', 'Dominix', 'Scorpion', 'Armageddon', 'Naga', 'Oracle', 'Talos', 'Tornado', 'Phantasm', 'Gila', 'Cynabal', 'Vigilant', 'Ashimmu', 'Bhaalgorn', 'Stratios', 'Orthrus', 'Barghest', 'Machariel', 'Nightmare', 'Vindicator', 'Rattlesnake', 'Dramiel', 'Worm', 'Daredevil', 'Cruor', 'Garmur', 'Venture', 'Prospect', 'Endurance', 'Porpoise', 'Orca', 'Rorqual', 'Bowhead', 'Charon', 'Fenrir', 'Obelisk', 'Ark', 'Providence', 'Thanatos', 'Chimera', 'Nidhoggur', 'Archon', 'Moros', 'Naglfar', 'Phoenix', 'Revelation', 'Avatar', 'Erebus', 'Ragnarok', 'Leviathan', 'Hel', 'Nyx', 'Aeon', 'Wyvern', 'Vulture', 'Basilisk', 'Cerberus', 'Wolf', 'Jaguar', 'Hawk', 'Harpy', 'Enyo', 'Ishkur', 'Retribution', 'Vengeance', 'Crusader', 'Taranis', 'Claw', 'Raptor', 'Crow', 'Hookbill', 'Corax', 'Kirin', 'Bifrost', 'Pontifex', 'Scalpel', 'Dagger', 'Stiletto', 'Malediction', 'Ares', 'Anathema', 'Helios', 'Buzzard', 'Cheetah', 'Manticore', 'Nemesis', 'Hound', 'Purifier', 'Keres', 'Hyena', 'Sentinel', 'Kitsune', 'Gnosis', 'Apotheosis', 'Echelon', 'Sunesis'].some(n => item.name.includes(n + ' Blueprint')) },
            { id: "ammunition_blueprints", name: "Ammunition Blueprints", filter: (item) => item.name.toLowerCase().includes('blueprint') && (item.name.toLowerCase().includes('charge') || item.name.toLowerCase().includes('crystal') || item.name.toLowerCase().includes('ammo') || item.name.toLowerCase().includes('missile') || item.name.toLowerCase().includes('torpedo') || item.name.toLowerCase().includes('rocket') || item.name.toLowerCase().includes('battery') || item.name.toLowerCase().includes('capacitor booster') || item.name.toLowerCase().includes('nanite paste') || item.name.toLowerCase().includes('bomb') || item.name.toLowerCase().includes('probe') && !item.name.toLowerCase().includes('launcher')) },
            { id: "drone_blueprints", name: "Drone Blueprints", filter: (item) => item.name.toLowerCase().includes('blueprint') && (item.name.toLowerCase().includes('drone') || item.name.toLowerCase().includes('fighter') || item.name.toLowerCase().includes('warrior') || item.name.toLowerCase().includes('valkyrie') || item.name.toLowerCase().includes('hobgoblin') || item.name.toLowerCase().includes('hammerhead') || item.name.toLowerCase().includes('ogre') || item.name.toLowerCase().includes('berserker') || item.name.toLowerCase().includes('wasp') || item.name.toLowerCase().includes('praetor') || item.name.toLowerCase().includes('infiltrator') || item.name.toLowerCase().includes('vespa') || item.name.toLowerCase().includes('hornet') || item.name.toLowerCase().includes('acolyte')) },
            ...
            { id: "other_blueprints", name: "Other Blueprints", filter: (item) => item.name.toLowerCase().includes('blueprint') && !item.name.toLowerCase().includes('reaction formula') }
        ]
    }
};
