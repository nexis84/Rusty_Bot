...
print("Using Fuzzwork CSV Data")
print("="*60)

# Step 1: Load groups to get category mappings
...
category_order = ['ships', 'modules', 'ammunition_and_charges', 'drones', 'implants_and_boosters', 'blueprints', 'materials', 'trade_goods', 'skills']
