...
## June 2, 2026 - Cradle of War: 4 Navy Destroyers

### Summary
Added 4 new destroyers from the Cradle of War expansion (launching June 9, 2026). Data sourced from EVE Online SDE build 3368760.

### Additions

| Ship | Race | Bonuses |
|------|------|---------|
| **Algos Navy Issue** | Gallente | Drone speed/hp/dmg, hybrid turret dmg+tracking, Stasis Webifier Drone |
| **Corax Navy Issue** | Caldari | Missile velocity, kinetic + EM/explosive/thermal dmg, explosion radius |
| **Dragoon Navy Issue** | Amarr | Drone speed/hp/dmg, small energy turret + missile dmg, neut range/falloff |
| **Talwar Fleet Issue** | Minmatar | Missile velocity, rate of fire, shield booster, explosion velocity |

### Files Modified
- `data/ships.json` — Added 4 new ship entries (Destroyer class, navy variants)

### Notes
- All bonuses verified 1:1 against SDE typeBonus.jsonl
- 4 Command Carriers (Salvation, Simurgh, Gaia, Ymir) deferred — not in SDE pre-release; will be added post-launch
